...
public class NHTests
{
    ...
    public readonly static List<int> input3 = CAG.ToList<int>(4, 4, 250, 500, 500);
    public readonly static List<int> input4 = CAG.ToList<int>(4, 4, 250, 500, 500);
    public readonly static List<int> input5 = CAG.ToList<int>(4, 4, 4, 4, 250, 500, 500);
    public readonly static List<double> input2 = CAG.ToList<double>(-5, -4, 7.5, 8.7, 3.4, 9.4, 0.8, 1.5, 2.6, 0.9, 0.6, 9.4, 8.4, 6.6, 9.4);
