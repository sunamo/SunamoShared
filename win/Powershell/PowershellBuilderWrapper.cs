...
/// <summary>
/// Wrapper protože jako interní využívá SunamoPS.PowershellBuilder
/// </summary>
public class PowershellBuilderWrapper : IPowershellBuilder
{
    ...
    public static PowershellBuilderWrapper ci = new PowershellBuilderWrapper();
    ...
    private PowershellBuilderWrapper()
    {
