...
public class PowershellRunnerWrapper : IPowershellRunner
{
    /// <summary>
    ...
    public static PowershellRunnerWrapper ci = new PowershellRunnerWrapper();
    ...
    private PowershellRunnerWrapper()
    {
